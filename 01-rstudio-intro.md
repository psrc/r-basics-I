...
![Rcreators](img/Ihaka-Gentleman.jpg)
<!--<img src="img/Ihaka-Gentleman.jpg " alt="Rcreators" />-->

Since then R increased on popularity enormously. Currently R has several million users. 

![](img/package_count.jpg)


Three most widely used applications in R (from RStudio survey 2018):

1. Statistical analysis (88%)
2. Visualization (85%)
3. Data transformation (78%)
...
If you haven't done so already, download and install [RStudio Desktop](https://rstudio.com/products/rstudio/download/).
...
of information, followed by a ">" and a blinking cursor. It operates on the idea of a "Read, evaluate,
